...
//        CGFloat xYuan =  self.black.center.x;
//        CGFloat yYuan =  self.black.center.y;
//      CGFloat  distanceC = sqrt(pow(xYuan - x, 2) + pow(yYuan - y, 2));
//        CGFloat b = distanceC / 2.0f;
//        CGFloat c = asinf(distanceC / r);
//        NSLog(@"值是多少%f",c);
////        asinf
